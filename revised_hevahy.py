...
#Define what is kmers and formula then if that kmers are not in counts then set it 0
#Otherwise, if kmers are in, add 1 incrementally
#Then return value, pass it into main function the counts expression.
...
#Define function to find other DNAs outside ACGT (find the wrong DNA)
...
#Define function of graph visualization (barwidth, opacity, color, label, legend, etc)
